...
const ICONS = {
  ...
  whatsapp: `<svg class="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.5C7.3 3.5 3.5 7.1 3.5 11.5C3.5 13.1 4 14.6 4.9 15.9L3.5 20.5L8.4 19.2C9.6 19.8 10.8 20 12 20C16.7 20 20.5 16.4 20.5 11.5C20.5 7.1 16.7 3.5 12 3.5Z"/><path d="M9 10.2C9 12.7 11 14.7 13.4 14.9C13.9 14.9 14.4 14.7 14.5 14.2L14.6 13.3C14.7 12.9 14.5 12.5 14.1 12.3L12.9 11.8C12.6 11.7 12.2 11.7 12 12L11.6 12.5C10.8 12 10.2 11.4 9.8 10.7L10.3 10.3C10.5 10.1 10.6 9.7 10.5 9.4L10 8.1C9.8 7.7 9.4 7.5 9 7.6L8.1 7.8C7.7 7.9 7.4 8.3 7.5 8.7C7.7 9.3 8.2 9.8 9 10.2Z" fill="currentColor" stroke="none"/></svg>`,
